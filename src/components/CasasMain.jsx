...
return (
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 p-4 ">
    ...
    <Component desenho= "img/desenhos/tecnicos/fachadas/fachada1.png" casa="img/casas/Tecnicos/Rua Trinta e Sete, 8.png" endereco="Vila dos tecnicos. Rua Trinta e Sete, 8" bairro="Tecnicos"  mapa="https://www.google.com/maps/d/u/0/viewer?mid=1W8_QiOSp1uzTWyAPHwDGDDFahhPzCUo&ll=-19.535900370685816%2C-42.643561228592745&z=21" />
  </div> 
 )
