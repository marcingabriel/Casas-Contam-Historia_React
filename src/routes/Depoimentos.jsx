  ...
  return (
    <section className="relative py-8" id="carousel_bf66">
      <div className="container mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8" id="depoimentos-container">
          {/* Aqui dentro será inserido o conteúdo dos depoimentos */}   
        </div>
      </div>

      <div className="absolute inset-0 mt-8 ml-8 w-1/5 h-64 rounded-full flex items-center justify-center text-gray-500 opacity-20 z-0">
